...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='simulation').find('simulation')
    default_model_path = os.path.join(pkg_share, 'models/robot/robot.urdf.xacro')
    default_rviz_config_path = os.path.join(pkg_share, 'config/urdf_config.rviz')
    world_path=os.path.join(pkg_share, 'worlds/gazebo_wro_world.sdf')
